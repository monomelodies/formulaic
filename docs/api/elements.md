...
### `File::isRequired(void)`

Custom `isRequired` check that also looks at the `$_FILES` superglobal.
...
value of 1 with a step size of 0.3 would give valid values of 1, 1.3, 1.6, 1.9,
2.1, 2.4 etc.
